(function() {'use strict';
  ...
  angular.module('sManagement').controller('LogoutController', LogoutController);

  /** @ngInject */
  function LogoutController($timeout, webDevTec, toastr, $scope, $state, $log, LoginService) {
    var vm = this;
    $scope.loginUser={};
